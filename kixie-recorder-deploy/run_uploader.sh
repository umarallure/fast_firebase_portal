...
echo "DEBUG: CSV_FILE variable: '$CSV_FILE'"
echo "DEBUG: Testing file: $CSV_FILE"
ls -la "$CSV_FILE" 2>/dev/null || echo "DEBUG: ls failed for $CSV_FILE"
if [ ! -f "$CSV_FILE" ]; then
