...
class CustomFieldsSSNExportService:
    ...
    async def export_data(self, account_ids: List[str], export_format: str = "csv") -> Dict[str, Any]:
        """Export opportunities data from selected accounts using dashboard export logic"""
        try:
            all_opportunities = []
            ...
            for account_id in account_ids:
                ...
                opportunities_data = await self.get_all_opportunities(account_config)
    ...
    async def preview_data(self, account_ids: List[str], limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            for account_id in account_ids:
                ...
                opportunities_data = await self.get_all_opportunities(account_config, limit=limit)
    ...
    async def get_all_opportunities(self, account_config: Dict[str, Any], limit: int = None) -> List[Dict[str, Any]]:
        """Get all opportunities for an account using dashboard export logic"""
        try:
            ...
            # Create dashboard export client
            export_client = DashboardExportService(api_key)
            
            try:
                # Get all pipelines
                pipelines = await export_client.get_pipelines()
                ...
                for pipeline in pipelines:
                    ...
                    opportunities = await export_client.get_opportunities(
    ...
    async def test_account_connection(self, account_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Test connection using dashboard export client
            export_client = DashboardExportService(api_key)
